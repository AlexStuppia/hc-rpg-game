...
public class Magic extends Action{
    ...
    public Magic(int id, String name, String effect, int quantity,int damage, Boolean isPriority, Boolean isPriorityLast, Boolean canTargetAlly, Boolean canTargetDeadAlly, Boolean canTargetDeadEnemy, Boolean canAttackMultiTarget, Integer numberOfTarget, Boolean isHittingAllEnemy, Boolean isHittingAllAlly, Boolean isHittingAllPlayer) {
        this.id = id;
        this.name = name;
        this.effect = effect;
